    ...
    <div>
      <section  className='my-11'>
        ...
        >
          ...
          >
            Aluminium Properties Prediction
          </motion.h1>
          <motion.p
            whileInView={{ opacity: 1 }}
            initial={{ opacity: 0 }}
          ...
          >
          We use ML to analyze the parameters influencing Alumimium Properties and control them to effectively obtain the final desired parameters of the Wire rod produced.
          </motion.p>
          <motion.div
            whileInView={{ opacity: 1 }}
            initial={{ opacity: 0 }}
